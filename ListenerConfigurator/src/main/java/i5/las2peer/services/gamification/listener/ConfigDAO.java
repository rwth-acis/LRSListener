...
public class ConfigDAO {
	...
	public void createGame(Connection conn, GameModel game) throws SQLException{
		stmt = conn.prepareStatement("INSERT INTO model.game_data(game_id, description, community_type) VALUES(?, ?, ?)");
	...
	public void createQuest(Connection conn, QuestModel quest) throws SQLException{
		stmt = conn.prepareStatement("INSERT INTO model.quest_data (quest_id, name, description, status, achievement_id, quest_flag, quest_id_completed, point_flag, point_value, use_notification , notif_message)  VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
	...
	public void createAchhievement(Connection conn, AchievementModel achievement) throws SQLException{
		stmt = conn.prepareStatement("INSERT INTO model.achievement_data (achievement_id, name, description, point_value, badge_id, use_notification, notif_message) VALUES (?, ?, ?, ?, ?, ?, ?)");
	...
	public void createBadge(Connection conn, BadgeModel badge) throws SQLException{
		stmt = conn.prepareStatement("INSERT INTO model.badge_data (badge_id, name, description, use_notification, notif_message) VALUES (?, ?, ?, ?, ?)");
	...
	public void createAction(Connection conn, ActionModel action) throws SQLException{
		stmt = conn.prepareStatement("INSERT INTO model.action_data (action_id, name, description, point_value, use_notification, notif_message) VALUES (?, ?, ?, ?, ?, ?)");
	...
	public void createLevel(Connection conn, LevelModel level) throws SQLException{
		stmt = conn.prepareStatement("INSERT INTO model.level_data (level_num, name, point_value, use_notification, notif_message ) VALUES (?, ?, ?, ?, ?)");
	...
	public QuestModel getQuestWithId(Connection conn, String questId) throws SQLException{
	...
	public void updateGame(Connection conn, GameModel game) throws SQLException{
		stmt = conn.prepareStatement("UPDATE model.game_data SET description = ?, community_type = ? WHERE game_id = ?");
	...
	public void updateQuest(Connection conn, QuestModel quest) throws SQLException{
		stmt = conn.prepareStatement("UPDATE model.quest_data SET name = ?, description = ?, status = ?, achievement_id = ?, quest_flag = ?, quest_id_completed = ?, point_flag = ?, point_value = ?, use_notification = ?, notif_message = ? WHERE quest_id = ?");
	...
	public void updateAchievement(Connection conn, AchievementModel achievement) throws SQLException{
		stmt = conn.prepareStatement("UPDATE model.achievement_data SET name = ?, description = ?, point_value = ?, badge_id = ?, use_notification = ?, notif_message = ? WHERE achievement_id = ?");
	...
	public void updateBadge(Connection conn, BadgeModel badge) throws SQLException{
		stmt = conn.prepareStatement("UPDATE model.badge_data SET name = ?, description = ?, use_notification = ?, notif_message = ? WHERE badge_id = ?");
	...
	public void updateAction(Connection conn, ActionModel action) throws SQLException{
		stmt = conn.prepareStatement("UPDATE model.action_data SET name = ?, description = ?, point_value = ?, use_notification = ?, notif_message = ? WHERE action_id = ?");
	...
	public void updateLevel(Connection conn, LevelModel level) throws SQLException{
		stmt = conn.prepareStatement("UPDATE model.level_data SET name = ?, point_value = ?, use_notification = ?, notif_message = ? WHERE level_num = ?");
	...
	public void addElementToMapping(Connection conn, String configId, String elementId, String listenTo, String type) throws SQLException{
		switch (type) {
		case "game": {
			stmt = conn.prepareStatement("INSERT INTO listen.game_info (config_id, game_id, listen_to) VALUES (?, ?, ?)");
			break;
		}
		case "quest": {
			stmt = conn.prepareStatement("INSERT INTO listen.quest_info (config_id, quest_id, listen_to) VALUES (?, ?, ?)");
			break;
		}
		case "achievement": {
			stmt = conn.prepareStatement("INSERT INTO listen.achievement_info (config_id, achievement_id, listen_to) VALUES (?, ?, ?)");
			break;
		}
		case "badge": {
			stmt = conn.prepareStatement("INSERT INTO listen.badge_info (config_id, badge_id, listen_to) VALUES (?, ?, ?)");
			break;
		}
		case "action": {
			stmt = conn.prepareStatement("INSERT INTO listen.action_info (config_id, action_id, listen_to) VALUES (?, ?, ?)");
			break;
		}
		case "level": {
			stmt = conn.prepareStatement("INSERT INTO listen.level_info (config_id, level_num, listen_to) VALUES (?, ?, ?)");
			break;
		}
		default:
	...
	public void removeElementFromMapping(Connection conn, String configId, String elementId, String type) throws SQLException{
		switch (type) {
		case "game": {
		...
		case "achievement": {
			stmt = conn.prepareStatement("DELETE FROM listen.achievement_info WHERE config_id = ? AND achievement_id = ?");
			break;
		}
		case "badge": {
